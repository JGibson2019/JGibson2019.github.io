    ...
    <Layout>
        <Head>
            ...
            <h3>For Us, Without Us: Addressing Tech's Shortcomings in Creating Equity for Black People</h3>
                ...
                <iframe title="For Us, Without Us recording" className={utilStyles.vidFrame} src="https://www.youtube.com/embed/Qzc6D8NZo-4" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
            <h3>Culture Fit: Racial Bias in Tech</h3>
                ...
                <iframe title="Culture Fit Spotify widget" className={utilStyles.spotifyFrame} src="https://open.spotify.com/embed/episode/30f2zimyhgxNypGjDrr1po?utm_source=generator&theme=0" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
            
            <h2>Developing with Accessibility in Mind</h2>
            <h3>Accessibility Insights: Catch accessibility bugs early and often</h3>
                <p>This is a version of a talk I present to technical audiences (developers, program/product managers, and designers) showcasing how teams can leverage our team's free, open-source accessibility testing options to find and fix accessibility issues. This particular recording is from the <a href="https://techa11y.dev/main-track/accessibility-insights-catch-accessibility-bugs-early-and-often/">2021 Tech A11y Summit</a>. John and I delivered an extended, live workshop version of this talk at the <a href="https://knowbility.org/programs/accessu-2022/accessibility-insights-web-and-android-development-with-accessibility-in-mind">2022 John Slatin AccessU Conference</a> sponsored by Knowbility. Our most recent presentation was at the <a href="https://youtu.be/AkCQ3k_qo4w?si=lMEDnbJi_vNsotQh">2023 Umbraco Community Days</a>!</p>
                <iframe title="Accessibility Insights: Catch accessibility bugs early and often recording" className={utilStyles.vidFrame} src="https://www.youtube.com/embed/93wpslHx4tc" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
            ...
            <h3>Bye Bye, BTS - Unpacking "Bye Bye Birdie"</h3>
                ...
                <iframe title="Bye Bye, BTS Spotify widget" className={utilStyles.spotifyFrame}src="https://open.spotify.com/embed/episode/262tceNX5FQF35OFvyhK1u?utm_source=generator&theme=0" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
            <h3>2019 UT Austin College of Natural Sciences Commencement</h3>
                ...
                <iframe title="2019 CNS Commencement recording" className={utilStyles.vidFrame} src="https://www.youtube.com/embed/zhwglPSkQz8" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
    </Layout>);
  }